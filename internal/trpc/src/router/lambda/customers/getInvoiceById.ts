...
const invoiceLineSchema = z.object({
  ...
  servicePeriodStartAt: z.number().int().nullable(),
  servicePeriodEndAt: z.number().int().nullable(),
  prorationFactor: z.number().finite().nullable(),
    ...
    return getInvoiceByIdOutputSchema.parse({
      invoice: {
        ...
        lines: linesResult.val.map((line) => ({
          ...
          servicePeriodStartAt: line.servicePeriodStartAt,
          servicePeriodEndAt: line.servicePeriodEndAt,
