-- Vendored from https://github.com/scoville/pgsql-ulid (MIT license).
-- See ./README.md for attribution and the pinned commit hash.
-- Modified to be idempotent: all functions use CREATE OR REPLACE.
