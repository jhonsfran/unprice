...
| Use-case | `internal/services/src/use-cases/plan-version/duplicate.ts` | Critical mutation path for plan configuration cloning | not-found, default-plan payment-method normalization, cloned feature/version consistency, transactional failure path |
