/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c4496473465b887a9144e3e7694a054e)
// Runtime types generated with workerd@1.20260219.0 2025-03-19 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	type LakehouseEventsStreamProdRecord = { event_date: string | number; schema_version: number; id: string; project_id: string; customer_id: string; request_id: string; idempotency_key: string; slug: string; timestamp: string | number; received_at: string | number; handled_at: string | number; state: string; rejection_reason?: string; properties: Record<string, unknown> };
	type LakehouseEventsStreamDevRecord = { event_date: string | number; schema_version: number; id: string; project_id: string; customer_id: string; request_id: string; idempotency_key: string; slug: string; timestamp: string | number; received_at: string | number; handled_at: string | number; state: string; rejection_reason?: string; properties: Record<string, unknown> };
	interface ProdEnv {
		LAKEHOUSE: R2Bucket;
		QUEUE_SHARD_0: Queue;
		QUEUE_SHARD_1: Queue;
		INGESTION_REPORTING_QUEUE: Queue;
		INGESTION_DLQ: Queue;
		...
		PIPELINE_EVENTS: import("cloudflare:pipelines").Pipeline<Cloudflare.LakehouseEventsStreamProdRecord>;
	}
	interface PreviewEnv {
		...
		RL_FREE_1000_60s: RateLimit;
		RL_FREE_6000_60s: RateLimit;
		PIPELINE_EVENTS: import("cloudflare:pipelines").Pipeline<Cloudflare.LakehouseEventsStreamDevRecord>;
	}
	interface DevEnv {
		LAKEHOUSE: R2Bucket;
		QUEUE_SHARD_0: Queue;
	...
	interface Env {
		...
		RL_FREE_1000_60s?: RateLimit;
		RL_FREE_6000_60s?: RateLimit;
		PIPELINE_EVENTS?: import("cloudflare:pipelines").Pipeline<Cloudflare.LakehouseEventsStreamProdRecord> | import("cloudflare:pipelines").Pipeline<Cloudflare.LakehouseEventsStreamDevRecord>;
		unprice_lakehouse_dev?: R2Bucket;
		unprice_lakehouse_prod?: R2Bucket;
	}
}
