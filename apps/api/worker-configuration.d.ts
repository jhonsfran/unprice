/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: acafbb03b90c95d65597d43e772a2fec)
...
declare namespace Cloudflare {
	...
	interface ProdEnv {
		LAKEHOUSE: R2Bucket;
		LAKEHOUSE_FILE_PLAN_BASE_URL: string;
		...
		PIPELINE_VERIFICATIONS: import("cloudflare:pipelines").Pipeline<import("cloudflare:pipelines").PipelineRecord>;
		PIPELINE_USAGE: import("cloudflare:pipelines").Pipeline<import("cloudflare:pipelines").PipelineRecord>;
		PIPELINE_METADATA: import("cloudflare:pipelines").Pipeline<import("cloudflare:pipelines").PipelineRecord>;
		PIPELINE_ENTITLEMENTS: import("cloudflare:pipelines").Pipeline<import("cloudflare:pipelines").PipelineRecord>;
	}
