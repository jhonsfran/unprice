...
import { completeProviderSignUp } from "@unprice/services/use-cases"
import { z } from "zod"
...
export const route = createRoute(
  defineEndpointContract(
    {
      path: "/v1/payment-provider-callbacks/{provider}/sign-up/{sessionId}/{projectId}",
      operationId: "paymentProviderCallbacks.signUp",
      // this endpoint is not public, so we hide it
      hide: true,
      summary: "provider sign up",
      description:
      ...
      request: {
        params: z.object({
          ...
          sessionId: z.string().openapi({
            description: "The provider session generated by the sign up process",
...
export type ProviderSignUpRequest = z.infer<typeof route.request.params>

export const registerProviderSignUpV1 = (app: App) =>
