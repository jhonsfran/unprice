...
import { registerProviderSetupV1 } from "./providerSetupV1"
...
const useCaseMocks = vi.hoisted(() => ({
  completeProviderSetup: vi.fn(),
}))

vi.mock("@unprice/services/use-cases", () => ({
  completeProviderSetup: useCaseMocks.completeProviderSetup,
}))

beforeEach(() => {
  useCaseMocks.completeProviderSetup.mockResolvedValue({
    val: {
...
describe("providerSetupV1 route", () => {
