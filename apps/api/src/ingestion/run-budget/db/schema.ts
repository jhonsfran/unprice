...
export const runState = sqliteTable("run_state", {
  ...
  lastCaptureSeq: integer("last_capture_seq").notNull().default(0),
...
export const runCaptureIntents = sqliteTable("run_capture_intents", {
  ...
  captureQuantity: real("capture_quantity"),
  rangeStartQuantity: real("range_start_quantity"),
  targetQuantity: real("target_quantity"),
  flushSeq: integer("flush_seq").notNull().default(0),
  rangeStartAmount: integer("range_start_amount").notNull().default(0),
