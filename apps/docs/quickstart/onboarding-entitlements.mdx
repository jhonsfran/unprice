...
<AccordionGroup>
  ...
  <Accordion title="Verify features">
    Verify checks if the customer has access to a feature, whether it is a flat feature or a usage-based one.
    See more [here](/libraries/ts/sdk/entitlements/verify)
...
You can also check out the [Features](/apis/features/ratelimiting) section for more information on how to use Unprice.
