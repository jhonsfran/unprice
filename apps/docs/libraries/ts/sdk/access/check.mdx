---
title: "Check access"
description: "Resolve whether a feature is usable for a customer."
---
...
<ResponseField name="limit" type="number">
    Active quota-window limit for usage features, or subscribed quantity for tier/package features.
...
<ResponseField name="quotaWindow" type="object | null">
    The quota window represented by `usage` and `limit`, with `startAt`, `endAt`, and `periodKey`.
    Timestamps use epoch milliseconds. `endAt` is exclusive and can be null for an open-ended window.
    The object is null when active grants use different windows.
</ResponseField>
