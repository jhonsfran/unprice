...
<ParamField body="usage" type="number">
    The amount of usage to check for. If provided, Unprice will verify if the customer has enough remaining balance to consume this amount without actually reporting it.
</ParamField>
